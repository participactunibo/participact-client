...
public class Task implements Serializable {
    ...
    Set<it.unibo.participact.domain.rest.Action> actions;
    ...
    public Set<it.unibo.participact.domain.rest.Action> getActions() {
        return actions;
    }

    public void setActions(Set<it.unibo.participact.domain.rest.Action> actions) {
    ...
    public boolean hasPipelineType(Pipeline.Type dataType) {
        ...
        for (it.unibo.participact.domain.rest.Action a : getActions()) {
