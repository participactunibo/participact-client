...
public class FriendsAcceptedAdapter extends ArrayAdapter<UserRestResult> {

    private final int resource;
    private final FriendRemoveListener friendRemoveListener;

    public FriendsAcceptedAdapter(Context context, int resource,
                                  List<UserRestResult> objects, FriendRemoveListener listener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.name = (TextView) convertView
                    .findViewById(R.id.friends_accepted_item_name);
            holder.image = (ImageView) convertView
                    .findViewById(R.id.imageView);
            holder.button = (ImageButton) convertView
                    .findViewById(R.id.friends_accepted_remove_button);
        ...
        holder.button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                friendRemoveListener.onFriendRemove(position);
