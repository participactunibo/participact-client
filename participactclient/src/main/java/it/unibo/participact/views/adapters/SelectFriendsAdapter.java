 ...
 */
public class SelectFriendsAdapter extends ArrayAdapter<UserRestResult> {

    private final int resource;
    private final FriendSelectedListener friendSelectedListener;

    public SelectFriendsAdapter(Context context, int resource,
                                  List<UserRestResult> objects, FriendSelectedListener listener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                holder.name.toggle();
                friendSelectedListener.onFriendSelected(position,holder.name.isChecked());
            }
        });
