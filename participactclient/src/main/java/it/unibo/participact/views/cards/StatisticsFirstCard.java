...
public class StatisticsFirstCard extends MyPlayCard {

    private static final String TITLE = "Statistiche";
    private static final String DESCRIPTION = "Questa scheda riassume alcune informazioni sul tuo profilo e in generale sull'esperimento.";
    ...
    public StatisticsFirstCard(Context context) {
