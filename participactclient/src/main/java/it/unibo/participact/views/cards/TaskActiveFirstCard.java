...
public class TaskActiveFirstCard extends MyPlayCard {

    private static final String TITLE = "Task Attivi";
    private static final String DESCRIPTION = "Questa scheda riassume le informazioni sui task attualmente in esecuzione.";
    private static final String COLOR = "#4ac925";
    private static final String TITLE_COLOR = "#4ac925";
    private static final boolean HAS_OVERFLOW = false;
    private static final boolean IS_CLICKABLE = false;


    public TaskActiveFirstCard(Context context) {
