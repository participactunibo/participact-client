...
/**
 * Created by alessandro on 07/11/14.
 */
public class TaskCreatedCompletedFirstCard extends MyPlayCard {

    private static final String TITLE = "Task Creati ";
    private static final String DESCRIPTION = "Questa scheda riassume le informazioni sui task creati da te e completati con successo da altri utenti.";
    ...
    public TaskCreatedCompletedFirstCard(Context context) {
