 ...
 */
public class TaskCreatedPendingFirstCard extends MyPlayCard {

    private static final String TITLE = "Task in Valutazione";
    private static final String DESCRIPTION = "Questa scheda riassume le informazioni sui task creati dall'utente in fase di valutazione.";
    ...
    public TaskCreatedPendingFirstCard(Context context) {
